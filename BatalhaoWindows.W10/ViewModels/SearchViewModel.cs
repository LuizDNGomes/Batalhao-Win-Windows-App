...
namespace BatalhaoWindows.ViewModels
{
    public class SearchViewModel : PageViewModelBase
    {
        ...
        public ListViewModel FaleConosco { get; private set; }
